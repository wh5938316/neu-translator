/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: ea22481ec0be7892c66f71a0433c0664)
// Runtime types generated with workerd@1.20251011.0 2024-12-30 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		DB: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* neu-translator */;
		ASSETS: Fetcher;
	}
}
